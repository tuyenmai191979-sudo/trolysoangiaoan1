...
<div class="main-header">
    ...
    <p>Tác giả: Mai Đức Tuyển - Trường PTDTBT Tiểu học Sủng Thài - ĐT: 081 2191 979</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Mai Đức Tuyển - Trường PTDTBT Tiểu học Sủng Thài - ĐT: 081 2191 979</div>", unsafe_allow_html=True)
